...
{
    public partial class CtrlLibrarianActivityLog : UserControl
    {
        ...
        public CtrlLibrarianActivityLog(Form form)
        {
            InitializeComponent();
        ...
        private void LoadFilters()
        {
            ...
            cmbFilter.Items.Add(ActivityTypeEnum.BOOK_TRANSACT);
            cmbFilter.Items.Add(ActivityTypeEnum.BOOK_OPERATION);
            cmbFilter.Items.Add(ActivityTypeEnum.COPY_OPERATION);
            cmbFilter.Text = "ALL";
        ...
        private async void LoadActivities()
        {
            ...
            ControllerAccessData<ActivityLog> res = await ActivityLogController.GetAllForLibrarian(currentPage, txtSearch.Text, ate);
